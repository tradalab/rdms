...
type AnalysisProfileEvent struct {
	Phase         string                `json:"phase"`
	Scanned       int64                 `json:"scanned"`
	Total         int64                 `json:"total"`
	Truncated     bool                  `json:"truncated"`
	Warnings      []string              `json:"warnings"`
	DistribSource string                `json:"distrib_source"`
	RedisVersion  string                `json:"redis_version"`
	Memory        AnalysisMemory        `json:"memory"`
	Ttl           AnalysisTtlStat       `json:"ttl"`
	Types         []AnalysisTypeStat    `json:"types"`
	Distrib       []AnalysisSizeDistrib `json:"distrib"`
	TopKeys       []AnalysisTopKey      `json:"top_keys"`
	Nodes         []AnalysisNode        `json:"nodes"`
	RecencyMetric string                `json:"recency_metric"`
}

type AnalysisProfileReq struct {
...
type AnalysisSizeDistrib struct {
	Kind    string           `json:"kind"`
	Unit    string           `json:"unit"`
	Buckets []AnalysisBucket `json:"buckets"`
}

type AnalysisTopKey struct {
	Key     string `json:"key"`
	Kind    string `json:"kind"`
...
type AnalysisTtlStat struct {
	Total    int64            `json:"total"`
	WithTtl  int64            `json:"with_ttl"`
	AvgTtlMs int64            `json:"avg_ttl_ms"`
	Buckets  []AnalysisBucket `json:"buckets"`
}

type AnalysisTypeStat struct {
	Kind  string `json:"kind"`
	Keys  int64  `json:"keys"`
	Bytes int64  `json:"bytes"`
}
