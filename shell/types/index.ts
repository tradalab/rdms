...
export interface AnalysisProfileEvent {
  ...
  truncated: boolean;
  warnings?: string[];
  distrib_source: string;
  redis_version: string;
  memory: AnalysisMemory;
  ttl: AnalysisTtlStat;
  types?: AnalysisTypeStat[];
  distrib?: AnalysisSizeDistrib[];
  top_keys?: AnalysisTopKey[];
  nodes?: AnalysisNode[];
  recency_metric: string;
}

export interface AnalysisProfileReq {
...
export interface AnalysisSizeDistrib {
  kind: string;
  unit: string;
  buckets?: AnalysisBucket[];
}

export interface AnalysisTopKey {
  key: string;
  kind: string;
  bytes: number;
  ttl_ms: number;
...
export interface AnalysisTtlStat {
  total: number;
  with_ttl: number;
  avg_ttl_ms: number;
  buckets?: AnalysisBucket[];
